...
<body>
    ...
    <form action="<?php echo e(route('peminjam.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\PerpustakaanSMKTI\resources\views/peminjam/create.blade.php ENDPATH**/ ?>